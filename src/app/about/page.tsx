        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 items-center">
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div className="flex flex-col gap-6 -translate-y-4 md:-translate-y-6">
              ...
              <div className="relative aspect-square mx-auto w-36 sm:w-44 md:w-56 overflow-hidden rounded-[16px]">
                <Image
                  src="https://images.unsplash.com/photo-1518893494013-481c19036ed0?q=80&w=1200&auto=format&fit=crop"
                  alt="Team member"
                  fill
                  className="object-cover"
                />
      ...
      <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[16px]">
            <Image src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=1200&auto=format&fit=crop" alt="Team member" fill className="object-cover" />
          </div>
          <div className="mt-4">
        ...
        <div>
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[16px]">
            <Image src="https://images.unsplash.com/photo-1518893494013-481c19036ed0?q=80&w=1200&auto=format&fit=crop" alt="Team member" fill className="object-cover" />
          </div>
          <div className="mt-4">
        ...
        <div>
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[16px]">
            <Image src="https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?q=80&w=1200&auto=format&fit=crop" alt="Team member" fill className="object-cover" />
          </div>
          <div className="mt-4">
        ...
        <div>
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[16px]">
            <Image src="https://images.unsplash.com/photo-1544717305-2782549b5136?q=80&w=1200&auto=format&fit=crop" alt="Team member" fill className="object-cover" />
          </div>
          <div className="mt-4">
        ...
        <div>
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[16px]">
            <Image src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=1200&auto=format&fit=crop" alt="Team member" fill className="object-cover" />
          </div>
          <div className="mt-4">
        ...
        <div>
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[16px]">
            <Image src="https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?q=80&w=1200&auto=format&fit=crop" alt="Team member" fill className="object-cover" />
          </div>
          <div className="mt-4">
        ...
        <div>
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[16px]">
            <Image src="https://images.unsplash.com/photo-1542053747-4f1a236b3d1d?q=80&w=1200&auto=format&fit=crop" alt="Team member" fill className="object-cover" />
          </div>
          <div className="mt-4">
